...
function setup() {
  ...
  gameOver = createSprite(trex.x+50,trex.y-50);
   restart = createSprite(trex.x+50,trex.y-30);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(trex.x+100,120,40,10);
